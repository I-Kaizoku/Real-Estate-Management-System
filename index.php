                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"We offer tailored real estate services to help clients buy, sell, or lease properties with ease, 
                                    ensuring every transaction is seamless and efficient."</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Our rental services connect clients with ideal properties, 
                                    offering a wide range of options to fit every lifestyle and budget."</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Our comprehensive property listings showcase a diverse range of residential and commercial properties,
                                     providing clients with the latest information and options to find their ideal space."</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Our real estate services include expert guidance on legal investment opportunities,
                                    ensuring compliance with regulations while maximizing returns."</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="living-list pr-4">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										<h5 class="mb-3">Unmatched Expertise in Real Estate Management</h5>
										<p>We bring years of industry experience to help you manage your properties with ease. Our platform is designed by professionals who 
                                            understand the complexities of property management, ensuring you have the tools you need for success.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Seamless, User-Friendly Platform</h5>
										<p>Managing your properties has never been easier. Our intuitive system allows you to handle everything—from rent collection 
                                            to maintenance requests—all in one place. </p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">24/7 Customer Support & Dedicated Service</h5>
										<p>We believe in offering more than just software—we offer a partnership. Our customer support team is available around 
                                            the clock to ensure that you receive the help and guidance you need, whenever you need it.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>We begin by understanding your unique needs and property management goals. Whether you're a first-time landlord or managing a large portfolio, 
                                our team works with you to define your objectives.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Once we’ve discussed your requirements, we move to the setup phase. Our experts assist you in configuring 
                                the system to match your property management needs.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>With your account set up, you're ready to take control of your property management. Our platform offers easy access to lease management, 
                                rent collection, maintenance tracking, and financial reporting.</p>
                        </div>
                    </div>
                </div>
            </div>

<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
										...
										<p class="pb-20 text-white">"At Homex, we are dedicated to transforming the way property management is done. 
                                            Our innovative platform empowers property owners, managers, and investors with the tools they need to efficiently 
                                            manage properties, reduce costs, and enhance tenant satisfaction. Whether you're handling a single rental unit or 
                                            a large portfolio, we offer tailored solutions that simplify day-to-day operations and drive growth. From automated 
                                            lease management to real-time financial reporting, we make it easier for you to focus on what matters most—your investment. 
                                            Let us help you unlock the full potential of your real estate assets."</p>
                                        </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Hitech city, Hyderabad</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 9652789522</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 9959888180</li>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© 2025 Homex All right reserved</span> </div>
                    <div class="col-sm-6">
